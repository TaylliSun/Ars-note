...
1. 下载 `Ars-note-Setup-1.5.64.exe`。
2. 校验发布页提供的 SHA256。
3. 运行安装程序并选择安装目录。
...
`v1.5.64` 是 Ars-note 的首个公开测试版。Windows 安装包暂未进行 Authenticode 签名，因此首次下载运行时可能出现 SmartScreen 提示。重要项目请继续保留独立备份，并在升级同步服务器前备份 `sync-data`。
